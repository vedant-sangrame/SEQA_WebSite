            ...
            <div key={item.id} className="retro-card">
              ...
              <div className="retro-card-footer">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <button
                    className={`upvote-btn ${item.voted_by?.includes(currentUser.email?.toLowerCase()) ? 'has-voted' : ''}`}
                    onClick={() => onUpvoteItem(item.id)}
                    title={item.voted_by?.includes(currentUser.email?.toLowerCase()) ? 'Remove your like' : 'Like this card'}
                  >
                    <ThumbsUp size={13} />
